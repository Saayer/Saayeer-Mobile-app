...
part of 'store_get_dto.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$StoreGetDto extends StoreGetDto {
  @override
  ...
  @override
  StoreGetDto rebuild(void Function(StoreGetDtoBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  StoreGetDtoBuilder toBuilder() => new StoreGetDtoBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is StoreGetDto &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'StoreGetDto')
...
class StoreGetDtoBuilder implements Builder<StoreGetDto, StoreGetDtoBuilder> {
  _$StoreGetDto? _$v;
  ...
  @override
  void replace(StoreGetDto other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$StoreGetDto;
  }

  @override
  void update(void Function(StoreGetDtoBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  StoreGetDto build() => _build();

  _$StoreGetDto _build() {
    final _$result = _$v ??
        new _$StoreGetDto._(
