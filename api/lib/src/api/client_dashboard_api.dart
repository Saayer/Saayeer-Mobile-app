...
class ClientDashboardApi {
  ...
  const ClientDashboardApi(this._dio, this._serializers);
  ...
  Future<Response<AmountPerDateResponse>> apiClientDashboardPaidPerDayPost({ 
    ...
    final _path = r'/api/ClientDashboard/paid-perDay';
    ...
    try {
      const _type = FullType(DateRangeDto);
      _bodyData = dateRangeDto == null ? null : _serializers.serialize(dateRangeDto, specifiedType: _type);
  ...
  Future<Response<CountPerDateResponse>> apiClientDashboardShipmentsPerDayPost({ 
    ...
    final _path = r'/api/ClientDashboard/shipments-perDay';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'Api-Key': apiKey,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ShipmentsCountResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ShipmentsCountResponse>> apiClientDashboardShipmentsPerStatusPost({ 
    required String apiKey,
    DateRangeDto? dateRangeDto,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/ClientDashboard/shipments-perStatus';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'Api-Key': apiKey,
    ...
    ShipmentsCountResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ShipmentsCountResponse),
      ) as ShipmentsCountResponse;
    ...
    return Response<ShipmentsCountResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
