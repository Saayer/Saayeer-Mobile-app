...
class CustomersApi {
  ...
  Future<Response<BuiltList<CustomerGetDto>>> apiCustomersGet({ 
    ...
    BuiltList<CustomerGetDto>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(CustomerGetDto)]),
      ) as BuiltList<CustomerGetDto>;
    ...
    return Response<BuiltList<CustomerGetDto>>(
      data: _responseData,
  ...
  Future<Response<BuiltList<CustomerGetDto>>> apiCustomersGetCustomersByPost({ 
    ...
    final _path = r'/api/Customers/GetCustomersBy';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        r'Api-Key': apiKey,
    ...
    try {
      const _type = FullType(CustomerQuery);
      _bodyData = customerQuery == null ? null : _serializers.serialize(customerQuery, specifiedType: _type);
  ...
  Future<Response<void>> apiCustomersIdDelete({ 
    ...
    final _path = r'/api/Customers/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        r'Api-Key': apiKey,
  ...
  Future<Response<CustomerGetDto>> apiCustomersIdGet({ 
    ...
    CustomerGetDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CustomerGetDto),
      ) as CustomerGetDto;
    ...
    return Response<CustomerGetDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<CustomerGetDto>> apiCustomersPost({ 
    ...
    try {
      const _type = FullType(CustomerAddDto);
      _bodyData = customerAddDto == null ? null : _serializers.serialize(customerAddDto, specifiedType: _type);
