...
class LogisticsApi {
  ...
  Future<Response<BuiltList<ShipmentCost>>> apiLogisticsShipmentCostsGet({ 
    ...
    BuiltList<ShipmentCost>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(ShipmentCost)]),
      ) as BuiltList<ShipmentCost>;
    ...
    return Response<BuiltList<ShipmentCost>>(
      data: _responseData,
