...
class AuthApi {
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TokenResponseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TokenResponseDto>> apiAuthTokenPost({ 
    required String apiKey,
    ...
    try {
      const _type = FullType(TokenRequestDto);
      _bodyData = tokenRequestDto == null ? null : _serializers.serialize(tokenRequestDto, specifiedType: _type);
    ...
    TokenResponseDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(TokenResponseDto),
      ) as TokenResponseDto;
