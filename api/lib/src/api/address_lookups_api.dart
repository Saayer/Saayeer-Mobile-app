...
class AddressLookupsApi {
  ...
  const AddressLookupsApi(this._dio, this._serializers);
  ...
  Future<Response<BuiltList<AddressLookUpDto>>> apiAddressLookupsAreasCityIdGet({ 
    ...
    final _path = r'/api/AddressLookups/Areas/{cityId}'.replaceAll('{' r'cityId' '}', encodeQueryParameter(_serializers, cityId, const FullType(int)).toString());
  ...
  Future<Response<BuiltList<AddressLookUpDto>>> apiAddressLookupsCitiesGovernorateIdGet({ 
    ...
    final _path = r'/api/AddressLookups/Cities/{governorateId}'.replaceAll('{' r'governorateId' '}', encodeQueryParameter(_serializers, governorateId, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        r'Api-Key': apiKey,
  ...
  Future<Response<BuiltList<AddressLookUpDto>>> apiAddressLookupsCountriesGet({ 
    ...
    final _path = r'/api/AddressLookups/Countries';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        r'Api-Key': apiKey,
  ...
  Future<Response<BuiltList<AddressLookUpDto>>> apiAddressLookupsGovernoratesCountryIdGet({ 
    ...
    final _path = r'/api/AddressLookups/Governorates/{countryId}'.replaceAll('{' r'countryId' '}', encodeQueryParameter(_serializers, countryId, const FullType(int)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        r'Api-Key': apiKey,
