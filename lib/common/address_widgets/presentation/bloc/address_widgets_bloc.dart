...
class AddressWidgetsBloc extends Bloc<AddressWidgetsEvent, AddressWidgetsState> {
  ...
  AddressWidgetsBloc({required this.getCitiesUseCase, required this.getCountriesUseCase, required this.getGovernoratesUseCase, required this.getAreasUseCase})
