...
import 'package:saayer/core/network/network_info.dart' as _i10;
...
import 'package:saayer/core/services/current_user/logged_in_service.dart'
    as _i7;
import 'package:saayer/core/services/injection/injectable_modules.dart' as _i58;
import 'package:saayer/core/services/local_storage/secure_storage_service.dart'
    as _i13;
import 'package:saayer/core/services/local_storage/shared_pref_service.dart'
    as _i14;
import 'package:saayer/core/services/navigation/navigation_service.dart' as _i9;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i6.LoggedInCheckerService>(() => _i6.LoggedInCheckerService());
    gh.singleton<_i7.LoggedInService>(_i7.LoggedInService());
    gh.factory<_i8.MoreBloc>(() => _i8.MoreBloc());
    ...
    gh.factory<_i42.UserCardRDS>(
        () => _i43.UserCardRDSImpl(apiConsumer: gh<_i18.ApiConsumer>()));
    gh.factory<_i44.UserCardRepo>(
        () => _i45.UserCardRepoImpl(userCardRDSImpl: gh<_i42.UserCardRDS>()));
    gh.factory<_i46.UserCardUseCase>(
        () => _i46.UserCardUseCase(userCardRepoImpl: gh<_i44.UserCardRepo>()));
    gh.factory<_i47.VerifyOtpRDS>(
        () => _i48.VerifyOtpRDSImpl(apiConsumer: gh<_i18.ApiConsumer>()));
    gh.factory<_i49.VerifyOtpRepo>(() =>
        _i50.VerifyOtpRepoImpl(verifyOtpRDSImpl: gh<_i47.VerifyOtpRDS>()));
    gh.factory<_i51.BusinessInfoBloc>(() => _i51.BusinessInfoBloc(
        submitBusinessInfoUseCase: gh<_i39.SubmitBusinessInfoUseCase>()));
    gh.factory<_i52.ConfirmLogInUseCase>(() =>
        _i52.ConfirmLogInUseCase(verifyOtpRepoImpl: gh<_i49.VerifyOtpRepo>()));
    gh.factory<_i53.LogInBloc>(
        () => _i53.LogInBloc(logInUseCase: gh<_i29.LogInUseCase>()));
    gh.factory<_i54.PersonalInfoBloc>(() => _i54.PersonalInfoBloc(
        submitPersonalInfoUseCase: gh<_i40.SubmitPersonalInfoUseCase>()));
    gh.factory<_i55.StoreInfoBloc>(() => _i55.StoreInfoBloc(
        submitStoreInfoUseCase: gh<_i41.SubmitStoreInfoUseCase>()));
    gh.factory<_i56.UserCardBloc>(
        () => _i56.UserCardBloc(userCardUseCase: gh<_i46.UserCardUseCase>()));
    gh.factory<_i57.VerifyOtpBloc>(() => _i57.VerifyOtpBloc(
          logInUseCase: gh<_i29.LogInUseCase>(),
          confirmLogInUseCase: gh<_i52.ConfirmLogInUseCase>(),
        ));
    return this;
  }
}

class _$InjectableModule extends _i58.InjectableModule {}
